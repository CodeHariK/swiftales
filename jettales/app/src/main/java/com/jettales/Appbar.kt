// https://github.com/android/snippets/blob/main/compose/snippets/src/main/java/com/example/compose/snippets/components/AppBar.kt
...
@Composable
fun AppBarExamples(navigateBack: () -> Unit) {
...
fun AppBarOptions(
    ...
    Column() {
        Button({ toBottom() }) { Text("Bottom bar") }
        Button({ toTopBarSmall() }) { Text("Small top bar") }
        Button({ toTopBarCenter() }) { Text("Center aligned top bar") }
        Button({ toTopBarMedium() }) { Text("Medium top bar") }
        Button({ toTopBarLarge() }) { Text("Large top bar") }
        Button({ toTopBarNavigation() }) { Text("Top bar navigation example") }
        Button({ toMultiSelection() }) { Text("Top bar with multi selection list") }
    }
}
    ...
    TopAppBar(
            ...
            actions = {
                if (hasSelection) {
                    ...
                    ) { Icon(imageVector = Icons.Filled.Share, contentDescription = "Share items") }
                }
            },
            modifier = modifier
    )
...
private fun AppBarMultiSelectionExample(
    ...
    Scaffold(modifier = modifier, topBar = { AppBarSelectionActions(selectedItems) }) { innerPadding
        ->
            ...
            itemsIndexed(listItems) { _, index ->
                ...
                ListItemSelectable(
                        ...
                        Modifier.combinedClickable(
                                ...
                                onLongClick = {
                                    if (isItemSelected) selectedItems -= index
...
@Composable
fun ListItemSelectable(selected: Boolean, modifier: Modifier = Modifier) {
...
private fun LazyListMultiSelectionPreview() {
    ...
    LazyListMultiSelection(listItems, modifier = Modifier)
}
